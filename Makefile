...
$(shell mkdir -p $(BUILD_DIR)/baserom $(BUILD_DIR)/assets/text $(foreach dir,$(SRC_DIRS) $(UNDECOMPILED_DATA_DIRS) $(ASSET_BIN_DIRS) $(ASSET_BIN_DIRS_HM_PACK),$(BUILD_DIR)/$(dir)))
...
$(BUILD_DIR)/$(SPEC): $(SPEC) spec.hm_pack_actors.inc spec.hm_pack_objects.inc
...
$(BUILD_DIR)/assets_hm_pack/%.o: assets_hm_pack/%.c
	$(CC) -c $(CFLAGS) $(MIPS_VERSION) $(OPTFLAGS) -o $@ $<
	$(OBJCOPY) -O binary $@ $@.bin
